...
from mcp.data_access_tools.query_builder_tool import QueryBuilderTool
from mcp.data_access_tools.vector_retrieval_tool import VectorRetrievalTool
from mcp.data_access_tools.db_executor_tool import DatabaseExecutorTool
...
class DataAccessOrchestrator:
    ...
    def __init__(self):
        ...
        self.query_builder = QueryBuilderTool()
        self.vector_tool = VectorRetrievalTool()
        self.db_tool = DatabaseExecutorTool()
    ...
    def _execute_sql_strategy(self, plan: Dict[str, Any], intent: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for query_spec in plan.get("queries", []):
            ...
            print(f"   📋 Executing: {method_name} with params: {params}")
            
            if hasattr(self.db_tool, method_name):
